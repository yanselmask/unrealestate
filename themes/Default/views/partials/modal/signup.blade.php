                 ...
                 <div class="row mx-0 align-items-center">
                     <div class="col-md-6 border-end-md p-4 p-sm-5">
                         ...
                         <ul class="list-unstyled mb-4 mb-sm-5">
                             <li class="d-flex mb-2">
                                 <i class="fi-check-circle text-primary mt-1 me-2"></i><span>Add and promote
                                     your listings</span>
                             </li>
                             <li class="d-flex mb-2">
                                 <i class="fi-check-circle text-primary mt-1 me-2"></i><span>Easily manage your
                                     wishlist</span>
                             </li>
                             <li class="d-flex mb-0">
                                 <i class="fi-check-circle text-primary mt-1 me-2"></i><span>Leave
                                     reviews</span>
                             </li>
                         </ul>
                         ...
                         <div class="mt-sm-4 pt-md-3">
                             ...
                             <a href="#signin-modal" data-bs-toggle="modal" data-bs-dismiss="modal">Sign
                                 in</a>
                         </div>
                     </div>
                     <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                         ...
                         <form class="needs-validation" novalidate>
                             ...
                             <div class="mb-4">
                                 <label class="form-label" for="signup-password">Password
